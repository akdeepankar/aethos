...
export function GatewallCard({ onSignIn, isSigningIn, error }: { onSignIn: () => void; isSigningIn: boolean; error?: string | null }) {
  return (
    <div
      style={{
        minHeight: "75vh",
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: "26px" }}>
          ...
          >
            Aethos Wealth Access
          </h1>
          <p style={{ fontSize: "13.5px", color: "#666666", margin: 0, lineHeight: "1.5" }}>
            Fundamental models, sectoral research, and IPO underwriting are reserved for authenticated members.
          </p>
        </div>
...
export function AuthGate({ children }: { children: React.ReactNode }) {
  ...
  // If already logged in and visiting /auth or /signin, redirect to target or /
  useEffect(() => {
    if (!loading && user && (pathname === "/auth" || pathname === "/signin")) {
    ...
    return (
      ...
      >
        ...
        <span style={{ fontSize: "13px", color: "#666666", fontWeight: "600" }}>
          Verifying Aethos Wealth membership...
        </span>
  ...
  // If not authenticated, render Gatewall Card
  if (!user) {
    ...
    return <GatewallCard onSignIn={handleSignIn} isSigningIn={isSigningIn} error={authError} />;
  }
